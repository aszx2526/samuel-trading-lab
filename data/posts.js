...
const posts = [
  {
    id: "naval44memo",
    title: "納瓦爾 3 小時訪談：關於人性、自由、幸福與成長的 44 個洞見",
    summary: "整理納瓦爾對幸福、慾望、財富、地位、名聲、自尊、關係、學習與自由的核心觀點。重點不在背下金句，而是辨識自己正在玩的是創造價值的正和遊戲，還是被比較、面子與焦慮綁住的地位遊戲。",
    date: "2026-07-07",
    category: "自我成長",
    threadUrl: null,
    readUrl: "articles/naval44memo.html"
  },
  {
    id: "effortlessmemo",
